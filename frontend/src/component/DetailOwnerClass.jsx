...
export default function DetailOwnerClass() { 
    ...
    <div className='mt-4'>
        <div className='flex gap-x-24'>
            ...
            <Link to={`/classes/detail-owner/${params.id}/members`} className='font-medium flex gap-x-2'>
                <img src="/group.png" className='w-6' alt="" />
                <span>Thành viên</span> 
            </Link>
           
            <Link to={`/classes/detail-owner/${params.id}/add-member`} className='font-medium flex gap-x-2'>
                <img src="/plus.png" className='w-6' alt="" />
                <span>Thêm học sinh</span>
               
            </Link>
            <Link to={`/classes/detail-owner/${params.id}/comments`} className='font-medium flex gap-x-2'>
                <img src="/plus.png" className='w-6' alt="" />
                <span>Thảo luận</span>
        ...
        <div className='flex gap-x-20 justify-between py-12'>
            ...
            <div className='flex flex-col gap-y-3 pr-12 w-96'>
                ...
                <div className='flex gap-x-3 items-center'>
                    <span className='text-blue-600 bg-[#F0F6F6] rounded-lg px-2 py-2'>onlinelearning.com/invite/a2g2d</span>
