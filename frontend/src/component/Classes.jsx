            ...
            <div className='flex gap-x-8 items-center'>
                ...
                <div className="max-w-md mx-auto">
                    <div className="relative">
                        ...
                        <input type="search" id="decks-search" className="block w-full px-4 py-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Tên, mô tả..." />
                    </div>
                </div>
            </div>
        </div>
